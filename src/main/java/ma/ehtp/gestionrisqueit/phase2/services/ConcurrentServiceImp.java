...
import ma.ehtp.gestionrisqueit.phase2.repositories.ConcurrentRepository;
import ma.ehtp.gestionrisqueit.phase2.repositories.ConcurrentRiskRepository;
  ...
  @Autowired
    ...
    public void deleteAll(List<Concurrent> concurrentList) {
        concurrentList.forEach(concurrent -> {
            concurrentRiskRepository.deleteAll(
                    concurrentRiskRepository.findByConcurrent(concurrent)
                     );
        });
        concurrentRepository.deleteAll(concurrentList);
    }
